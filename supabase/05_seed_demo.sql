...
('t0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000099', 1, 'Window 1', 4, 'available'),
('t0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000099', 2, 'Window 2', 4, 'occupied'),
('t0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000099', 3, 'Family', 6, 'available'),
('t0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000099', 4, 'Patio', 4, 'reserved'),
('t0000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000099', 5, 'Corner', 2, 'available')
on conflict (id) do nothing;
...
('o0000000-0000-0000-0000-000000000001', 'ORD-DEMO-001', 'b0000000-0000-0000-0000-000000000099', 2, 'dine_in', 'waiter', 'pending', 580, 0, 580, 'Less spicy', now() - interval '8 minutes'),
('o0000000-0000-0000-0000-000000000002', 'ORD-DEMO-002', 'b0000000-0000-0000-0000-000000000099', 4, 'dine_in', 'qr_customer', 'preparing', 460, 0, 460, null, now() - interval '18 minutes'),
('o0000000-0000-0000-0000-000000000003', 'ORD-DEMO-003', 'b0000000-0000-0000-0000-000000000099', null, 'takeaway', 'cashier', 'ready', 390, 0, 390, null, now() - interval '28 minutes')
on conflict (id) do nothing;

insert into order_items (order_id, branch_id, dish_id, dish_name, quantity, price_at_order, status) values
('o0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000099', 'd0000000-0000-0000-0000-000000000001', 'Paneer Tikka', 1, 260, 'pending'),
('o0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000099', 'd0000000-0000-0000-0000-000000000002', 'Chicken 65', 1, 320, 'pending'),
('o0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000099', 'd0000000-0000-0000-0000-000000000003', 'Dal Makhani', 1, 280, 'preparing'),
('o0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000099', 'd0000000-0000-0000-0000-000000000005', 'Garlic Naan', 2, 70, 'preparing'),
('o0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000099', 'd0000000-0000-0000-0000-000000000004', 'Butter Chicken', 1, 390, 'ready')
on conflict do nothing;

insert into payments (order_id, branch_id, amount, method, status, transaction_id) values
('o0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000099', 390, 'upi', 'completed', 'UPI-DEMO-003')
on conflict do nothing;

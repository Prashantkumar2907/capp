...
export const PERFORMANCE_BUDGETS = [
  {
    ...
    indexedHotPaths: ["idx_branch_dishes_branch", "idx_tables_branch"],
  ...
  },
  {
    ...
    indexedHotPaths: ["idx_orders_branch_client_request", "idx_orders_branch_created"],
  ...
  },
  {
    ...
    indexedHotPaths: ["idx_orders_branch_status", "idx_order_items_order"],
    trustBoundaries: ["server_role_permissions", "server_tenant_scope"],
    viewports: CRITICAL_VIEWPORTS,
  },
  {
    ...
    indexedHotPaths: ["idx_branch_dishes_branch", "idx_orders_branch_client_request"],
  ...
  },
  {
    ...
    indexedHotPaths: ["idx_payments_branch_created", "idx_payments_order", "idx_payments_transaction"],
  ...
  },
  {
    ...
    indexedHotPaths: ["idx_dishes_org", "idx_dishes_category", "idx_branch_dishes_branch"],
